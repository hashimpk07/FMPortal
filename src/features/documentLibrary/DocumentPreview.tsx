...
import { Close, Download, Launch, Link as LinkIcon } from '@mui/icons-material';
...
const documents: Document[] = [
    {
        id: 1,
        name: 'Building Invoice 1',
        pdfUrl: 'https://example.com/document2.pdf',
    },
    {
        id: 2,
        name: 'Building Invoice 2',
        pdfUrl: 'https://example.com/document2.pdf',
    },
    {
        id: 3,
        name: 'Building Invoice 3',
...
const DocumentPreview = ({ setDocumentPreviewModal }: DocumentPreviewProps) => {
    const { t } = useTranslation();
    // State to hold the selected document
    const [selectedDocument, setSelectedDocument] = useState<Document | null>(documents[1]);
